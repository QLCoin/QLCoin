...
unlocked to sign the qlcoin-QT.app bundle.
...
allowing somebody to distribute a qlcoin-QT.app or qlcoin-qt-setup.exe with a valid
...
that the qlcoin-qt.exe file inside the installer had not been tampered with.
